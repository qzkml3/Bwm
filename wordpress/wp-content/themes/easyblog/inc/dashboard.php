				...
				<div class="theme_info_column clearfix">
					<div class="theme_info_left">
						...
						<div class="theme_link">
							...
							<p>
								<a href="<?php echo esc_url( 'http://docs.famethemes.com/article/131-easyblog-documentation' ); ?>" target="_blank" class="button button-secondary"><?php esc_html_e('Online Documentation', 'easyblog'); ?></a>
							</p>
						</div>
					</div>
